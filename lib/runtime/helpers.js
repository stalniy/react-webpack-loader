...
function resolveStyles (staticStyles, styles) {
  if (staticStyles.constructor !== Object) {
    staticStyles = normalizeStyleBinding(staticStyles)
  }
  ...
  return Object.assign(staticStyles, styles)
}
