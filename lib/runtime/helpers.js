...
function resolveReferenceProp () {
  return this[META_PROP].refs || (this[META_PROP].refs = {})
}

export function installDataHelpers (object) {
  object.render = renderTree
  Object.defineProperty(object, '$slots', { get: resolveComponentSlots })
  Object.defineProperty(object, '$scopedSlots', { get: resolveComponentScopedSlots })
  Object.defineProperty(object, '$refs', { get: resolveReferenceProp })
  Object.defineProperty(object, '_cc', {
    get () {
  ...
  Object.defineProperty(object, META_PROP, {
    configurable: true,
    get () {
      const meta = { cache: {}}
